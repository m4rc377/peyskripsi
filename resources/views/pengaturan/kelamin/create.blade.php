    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Tambah Kelamin</h5>
            </div>
            <form role="form" action="{{ route('kelamin.store') }}" method="post">
                <div class="card-body">
                    <div class="form-group">
                        <label for="kelamin">Nama Kelamin</label>
                        <input type="text" inputmode="numeric" class="form-control" id="kelamin" name="kelamin" placeholder="Nama Kelamin"
                            autocomplete="off">
                    </div>
                </div>
