...
@section('title', 'Pengaturan Tunjangan Gaji')
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Daftar Tunjangan Gaji</h5>
                <div class="card-tools mr-1">
                    <button type="button" class="btn btn-primary" onclick="window.location.href='{{route('gaji-tunjangan.create')}}'">
                                        ...
                                        <ul class="list-inline m-0">
                                            <li class="list-inline-item">
                                                <button class="btn btn-success btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top"
                                                    title="Edit" onclick="window.location='{{ route("gaji-tunjangan.edit", $result->token ) }}'"><i class="fa fa-edit"></i></button>
                                            </li>
                                            <li class="list-inline-item">
                                                <form action="{{ route('gaji-tunjangan.destroy', $result->token)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
