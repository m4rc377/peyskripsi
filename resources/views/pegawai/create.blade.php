                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" inputmode="numeric" class="form-control" id="nip"
                                                name="nip" placeholder="NIP (Nomor Induk Pegawai)" value="{{old('nip')}}">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="posisi" id="posisi" class="form-control select2noadd" style="width: 100%;">
                                                ...
                                                <option value="{{$posisi->nama}}" {{ old('posisi') == $posisi->nama ? "selected" : "" }}>{{$posisi->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="golongan" id="golongan" class="form-control select2noadd" style="width: 100%;">
                                                ...
                                                <option {{ old('golongan') == $golongan->nama ? "selected" : "" }} value="{{$golongan->nama}}">{{$golongan->nama}} ({{$golongan->kode}})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="month_years" data-target-input="nearest">
                                                <input placeholder="Tahun Pengangkatan" type="text" class="form-control datetimepicker-input" aria-labelledby='ttl' data-target="#month_years" name="tahun_pengangkatan" value="{{old('tahun_pengangkatan')}} id="input_month_years" data-toggle="datetimepicker" />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="pendididkan_gelar_awal" id="pendididkan_gelar_awal" class="form-control select2noadd"
                                                            ...
                                                            <option {{ old('pendididkan_gelar_awal') == $pendididkan_gelar->nama ? "selected" : "" }} value="{{$pendididkan_gelar->nama}}">{{$pendididkan_gelar->nama}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="pendididkan_institusi_awal" id="pendididkan_institusi_awal" class="form-control select2noadd" style="width: 100%;">
                                                            ...
                                                            <option {{ old('pendididkan_institusi_awal') == $pendididkan_institusi->nama ? "selected" : "" }} value="{{$pendididkan_institusi->nama}}">{{$pendididkan_institusi->nama}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="pendididkan_gelar_terakhir" id="pendididkan_gelar_terakhir" class="form-control select2noadd" style="width: 100%;">
                                                            <option selected="selected" disabled>Pilih</option>
                                                            @foreach ($results->pendididkan_gelar as $pendididkan_gelar)
                                                            <option {{ old('pendididkan_gelar_terakhir') == $pendididkan_gelar->nama ? "selected" : "" }} value="{{$pendididkan_gelar->nama}}">{{$pendididkan_gelar->nama}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="pendididkan_institusi_terakhir" id="pendididkan_institusi_terakhir" class="form-control select2noadd" style="width: 100%;">
                                                            <option selected="selected" disabled>Pilih</option>
                                                            @foreach ($results->pendididkan_institusi as $pendididkan_institusi)
                                                            <option {{ old('pendididkan_institusi_terakhir') == $pendididkan_institusi->nama ? "selected" : "" }} value="{{$pendididkan_institusi->nama}}">{{$pendididkan_institusi->nama}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" inputmode="numeric" class="form-control" id="npwp" name="npwp" placeholder="Nomor Wajib pajak (NPWP)" value="{{old('npwp')}}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kelamin" id="kelamin"
                                                ...
                                                <option {{ old('kelamin') == $kelamin->nama ? "selected" : "" }} value="{{$kelamin->nama}}">{{$kelamin->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select id="agama" name="agama" class="form-control select2noadd" style="width: 100%">
                                                ...
                                                <option {{ old('agama') == $agama->nama ? "selected" : "" }} value="{{$agama->nama}}">{{$agama->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="kota_lahir" aria-labelledby='ttl' name="kota_lahir" placeholder="Kota lahir" value="{{old('kota_lahir')}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date" id="tanggal_lahir" data-target-input="nearest">
                                                            <input type="text" placeholder="Tanggal Lahir" class="form-control datetimepicker-input" aria-labelledby='ttl' data-target="#tanggal_lahir" name="tanggal_lahir" value="{{old('tanggal_lahir')}}" id="input_tanggal_lahir" data-toggle="datetimepicker" />
                                            ...
                                            <select name="status_pernikahan" id="status_pernikahan" class="form-control select2noadd" style="width: 100%;">
                                                ...
                                                <option {{ old('status_pernikahan') == $status_pernikahan->nama ? "selected" : "" }} value="{{$status_pernikahan->nama}}">{{$status_pernikahan->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
