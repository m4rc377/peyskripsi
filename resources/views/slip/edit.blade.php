                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="posisi" id="posisi" class="form-control select2noadd" style="width: 100%;">
                                                ...
                                                <option value="{{$jabatan_posisi->nama}}" {{($jabatan_posisi->nama == $results->posisi) ? 'selected' : ''}}>{{$jabatan_posisi->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="golongan" id="golongan" class="form-control select2noadd" style="width: 100%;">
                                                ...
                                                <option value="{{$jabatan_golongan->nama}}" {{($jabatan_golongan->nama == $results->golongan) ? 'selected' : ''}}>{{$jabatan_golongan->nama}} ({{$jabatan_golongan->kode}})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status_pegawai" id="status_pegawai" class="form-control select2noadd" style="width: 100%;">
                                                <option selected="selected" disabled>Pilih</option>
                                                @foreach ($data->status_pegawai as $status_pegawai)
                                                <option value="{{$status_pegawai->nama}}" {{($status_pegawai->nama == $results->status_pegawai) ? 'selected' : ''}}>{{$status_pegawai->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </fieldset>
